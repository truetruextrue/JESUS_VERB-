...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre impulso primordial.
...
sistema = Sistema()
sistema.carregar_modulo("formula_delta")
sistema.ativar()
```
