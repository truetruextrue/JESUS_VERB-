...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre a chave do sistema.
...
sistema = Sistema()
sistema.carregar_modulo("ativacao_completa")
sistema.ativar()
```
