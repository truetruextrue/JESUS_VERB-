...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre memória do sistema.
...
sistema = Sistema()
sistema.carregar_modulo("memoria_viva")
sistema.ativar()
```
