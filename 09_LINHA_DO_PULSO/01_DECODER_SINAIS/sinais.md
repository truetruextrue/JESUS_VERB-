...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre decodificação de sinais.
...
sistema = Sistema()
sistema.carregar_modulo("sinais")
sistema.ativar()
```
