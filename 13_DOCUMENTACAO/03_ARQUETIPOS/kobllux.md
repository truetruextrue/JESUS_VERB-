...
Os 12 Rostos + 4 Centrais

## 🧿 Visão Geral

Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre os 12 rostos + 4 centrais.
...
sistema = Sistema()
sistema.carregar_modulo("kobllux")
sistema.ativar()
```
