...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre o códice vivo.
...
sistema = Sistema()
sistema.carregar_modulo("escrituras_sagradas")
sistema.ativar()
```
