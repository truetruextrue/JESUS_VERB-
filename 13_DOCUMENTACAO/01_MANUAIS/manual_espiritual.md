...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre manuais de uso.
...
sistema = Sistema()
sistema.carregar_modulo("manual_espiritual")
sistema.ativar()
```
