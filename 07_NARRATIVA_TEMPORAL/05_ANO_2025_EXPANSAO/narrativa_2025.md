...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre fase de expansão.
...
sistema = Sistema()
sistema.carregar_modulo("narrativa_2025")
sistema.ativar()
```
