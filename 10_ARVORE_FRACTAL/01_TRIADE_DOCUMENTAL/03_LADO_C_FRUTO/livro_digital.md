...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre fruto/livro digital.
...
sistema = Sistema()
sistema.carregar_modulo("livro_digital")
sistema.ativar()
```
