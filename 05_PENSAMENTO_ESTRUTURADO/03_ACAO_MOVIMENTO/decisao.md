...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre implementar decisão.
...
sistema = Sistema()
sistema.carregar_modulo("decisao")
sistema.ativar()
```
