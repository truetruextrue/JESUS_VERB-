...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre coletar informações do ambiente.
...
sistema = Sistema()
sistema.carregar_modulo("coleta_dados")
sistema.ativar()
```
