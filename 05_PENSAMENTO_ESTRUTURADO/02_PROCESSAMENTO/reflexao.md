...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre refletir e integrar.
...
sistema = Sistema()
sistema.carregar_modulo("reflexao")
sistema.ativar()
```
