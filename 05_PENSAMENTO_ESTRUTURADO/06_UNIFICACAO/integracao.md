...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre integrar todas as camadas.
...
sistema = Sistema()
sistema.carregar_modulo("integracao")
sistema.ativar()
```
