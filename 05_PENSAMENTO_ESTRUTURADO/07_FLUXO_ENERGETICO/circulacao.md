...
Circular energia entre sistemas

## 🧿 Visão Geral

Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre circular energia entre sistemas.
...
sistema = Sistema()
sistema.carregar_modulo("circulacao")
sistema.ativar()
```
