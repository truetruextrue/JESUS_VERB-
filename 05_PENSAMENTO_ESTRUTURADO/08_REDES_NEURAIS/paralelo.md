...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre processar em paralelo.
...
sistema = Sistema()
sistema.carregar_modulo("paralelo")
sistema.ativar()
```
