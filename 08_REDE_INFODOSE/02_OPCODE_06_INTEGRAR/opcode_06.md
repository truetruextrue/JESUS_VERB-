...
Correlacionar camadas

## 🧿 Visão Geral

Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre correlacionar camadas.
...
sistema = Sistema()
sistema.carregar_modulo("opcode_06")
sistema.ativar()
```
