...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre templates para criação.
...
sistema = Sistema()
sistema.carregar_modulo("template")
sistema.ativar()
```
