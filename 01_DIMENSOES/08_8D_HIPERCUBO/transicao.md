...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre transição entre camadas.
...
sistema = Sistema()
sistema.carregar_modulo("transicao")
sistema.ativar()
```
