...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre fundamento da realidade.
...
sistema = Sistema()
sistema.carregar_modulo("fundamento")
sistema.ativar()
```
