...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre unificação total.
...
sistema = Sistema()
sistema.carregar_modulo("unificacao")
sistema.ativar()
```
