...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre padrões que se repetem.
...
sistema = Sistema()
sistema.carregar_modulo("padroes")
sistema.ativar()
```
