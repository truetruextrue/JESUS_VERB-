...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre fluxo da evolução.
...
sistema = Sistema()
sistema.carregar_modulo("fluxo_evolucao")
sistema.ativar()
```
