/* ═══════════════════════════════════════════════════════════
   0x04 · DISSOLVER · B · D3
   ═══════════════════════════════════════════════════════════
   Arquivo   : fusion-card-core-isolado/js/L4_0x04_block-0_B_D3.js
...
// ═══════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════
    // [JS::ORB-GENERATOR]  makeOrbAvatar(name, size)
    //   gera SVG determinístico a partir do nome (seed por charCode)
    // ═══════════════════════════════════════════════════════════