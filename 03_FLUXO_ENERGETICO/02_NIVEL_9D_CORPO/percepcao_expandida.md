...
Este documento faz parte do **KOBLLUX TRINITY SYSTEM**, versão 7.9, e contém informações detalhadas sobre corpo multidimensional.
...
sistema = Sistema()
sistema.carregar_modulo("percepcao_expandida")
sistema.ativar()
```
